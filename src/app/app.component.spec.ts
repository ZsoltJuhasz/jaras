...
describe('AppComponent tesztelése', () => {
  ...
  it('A container div létezik', () => {
    ...
    expect(divElem.length).toBe(1); //azt teszteljük, hogy 1 darab dive elem van a .html fájlban
  });

  it('A gyermek komponens létezik', () => {
    const fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
    const divElem = fixture.debugElement.queryAll(By.css('app-vehicle')); //csak a tag neve kell <> ezek nem kellenek
